...
function updateBestScore() {
  bestScoreArray.forEach((score, index) => {
    ...
    if (questionAmount == score.questions) {
      ...
      // Update if the new final score is lessor replacing zero
...
function countdownStart() {
  ...
  countdownInterval = setInterval(function showCountdownValue() {
    if (countdownValue > 0) {
